...
struct provider_helper_runtime_stats {
    ...
    uint64_t ike_auth_eap_tls_client_hello_rx;
    ...
    uint64_t ike_auth_allow_eap_success_tx;
    uint64_t ike_auth_allow_eap_success_failed;
    ...
    uint64_t ike_sa_xfrm_lease_revoked;
    ...
    uint64_t ike_create_child_response_tx;
    uint64_t ike_create_child_response_failed;
    uint64_t ike_child_sa_xfrm_delete_ok;
