    ...
    int version)
{
    const struct provider_helper_status_counter counters[] = {
        ...
        { "ike_auth_natt_migrated", stats->ike_auth_natt_migrated },
        { "ike_auth_decrypted", stats->ike_auth_decrypted },
        { "ike_auth_decrypt_failed", stats->ike_auth_decrypt_failed },
        { "ike_auth_inner_parsed", stats->ike_auth_inner_parsed },
        { "ike_auth_inner_malformed", stats->ike_auth_inner_malformed },
        { "ike_auth_idi_extracted", stats->ike_auth_idi_extracted },
        { "ike_auth_idi_invalid", stats->ike_auth_idi_invalid },
        { "ike_auth_eap_tls_rx", stats->ike_auth_eap_tls_rx },
        { "ike_auth_denied", stats->ike_auth_denied },
        { "ike_auth_deny_response_tx", stats->ike_auth_deny_response_tx },
        { "ike_auth_deny_response_failed",
          stats->ike_auth_deny_response_failed },
        { "ike_auth_request_tx", stats->ike_auth_request_tx },
        { "ike_auth_request_pending_dropped",
          stats->ike_auth_request_pending_dropped },
        { "ike_auth_request_failed", stats->ike_auth_request_failed },
        { "ike_auth_allow_missing_xfrm_lease",
          stats->ike_auth_allow_missing_xfrm_lease },
        { "ike_auth_allow_eap_success_tx",
          stats->ike_auth_allow_eap_success_tx },
        { "ike_auth_allow_eap_success_failed",
        ...
        { "ike_auth_final_auth_rx", stats->ike_auth_final_auth_rx },
        { "ike_auth_final_auth_bad_shape",
          stats->ike_auth_final_auth_bad_shape },
        { "ike_auth_final_auth_verify_failed",
          stats->ike_auth_final_auth_verify_failed },
        { "ike_auth_final_auth_verified",
        ...
        { "ike_informational_delete_request_tx",
          stats->ike_informational_delete_request_tx },
        { "ike_informational_delete_request_failed",
          stats->ike_informational_delete_request_failed },
        { "ike_dpd_request_tx", stats->ike_dpd_request_tx },
        { "ike_dpd_request_failed", stats->ike_dpd_request_failed },
        { "ike_dpd_response_rx", stats->ike_dpd_response_rx },
        { "ike_dpd_response_malformed", stats->ike_dpd_response_malformed },
        { "ike_dpd_retransmit_tx", stats->ike_dpd_retransmit_tx },
        { "ike_dpd_retransmit_failed", stats->ike_dpd_retransmit_failed },
        { "ike_dpd_timeout", stats->ike_dpd_timeout },
        { "ike_mobike_update_rx", stats->ike_mobike_update_rx },
        { "ike_mobike_peer_migrated", stats->ike_mobike_peer_migrated },
        { "ike_create_child_unsupported_rx",
          stats->ike_create_child_unsupported_rx },
        { "ike_create_child_rekey_rx",
          stats->ike_create_child_rekey_rx },
        ...
        { "ike_create_child_temp_failure_tx",
          stats->ike_create_child_temp_failure_tx },
        { "ike_create_child_temp_failure_failed",
          stats->ike_create_child_temp_failure_failed },
        { "ike_create_child_no_proposal_tx",
        ...
        { "ike_create_child_ts_unacceptable_tx",
...
bool
provider_helper_supervisor_send_server_auth_config(
    struct provider_helper_supervisor *supervisor,
    ...
    uint64_t correlation_id)
{
    ...
    const struct provider_helper_msg_header header = {
        ...
        .version_major = PROVIDER_HELPER_IPC_VERSION_MAJOR,
        .version_minor = PROVIDER_HELPER_IPC_VERSION_MINOR,
        .type = PROVIDER_HELPER_MSG_SERVER_AUTH_CONFIG,
        .sequence = supervisor->next_tx_sequence++,
        .correlation_id = correlation_id,
        .payload_len = PROVIDER_HELPER_SERVER_AUTH_CONFIG_SIZE,
    };

    const bool encoded =
        provider_helper_ipc_write_header(&buf, &header)
        && provider_helper_ipc_write_server_auth_config(&buf, config);
    const bool written = encoded
                         && provider_helper_write_all(supervisor->ipc_fd, BPTR(&buf),
                                                      (size_t)BLEN(&buf));
    free_buf(&buf);
